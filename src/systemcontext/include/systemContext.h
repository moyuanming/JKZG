...
int Get_CurrentCartypeIndex(void);
...
int GetIsDowngradedMode(void);
void InitUserNumAndNameAndOnJobDateTime(void);
//登录成功后
void LoginSuccess(void);
void LoginOutSuccess(void);
void Set_AllKindData(int carTypeIndex,int carKindIndex,float TollFare);
void TransDoTuoche(void);
//线程
void  Setg_idComKeyThread(pthread_t  value);
pthread_t  Getg_idComKeyThread(void);
void  Setg_idPrintThread(pthread_t  value);
pthread_t  Getg_idPrintThread(void);
void  Setg_Message(pthread_t  value);
pthread_t  Getg_Message(void);
void  Setg_Connect(pthread_t  value);
pthread_t  Getg_Connect(void);
void  Setg_Devhread(pthread_t   value);
int  Getg_Devhread(void);
 int Getg_Devhread_Locate(void);
