...
#define V4L2_IN_ST_FIDT		   0x00080000  //FIDT bits is set?
...
#define VIDIOC_G_TEST      	_IOWR ('V', 70, struct v4l2_test)
#define VIDIOC_S_TEST      	_IOWR ('V', 71, struct v4l2_test)
...
struct v4l2_i2c_sequence
{
	__u8		address;
	__u8		sequence[257];		//! sequence[0] is the subaddress
									//! values start from sequence[1]
	__u32		length;				//! valid length of sequence, include subaddress
};

#define		VIDIOC_G_I2CDATA		_IOWR('V',201,struct v4l2_i2c_data)
#define		VIDIOC_S_I2CDATA		_IOWR('V',202,struct v4l2_i2c_data)
#define		VIDIOC_G_I2CSEQUENCE	_IOWR('V',203,struct v4l2_i2c_sequence)
#define		VIDIOC_S_I2CSEQUENCE	_IOWR('V',204,struct v4l2_i2c_sequence)
